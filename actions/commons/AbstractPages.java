...
import pageObjects.nopCommerce.AbstractNopCommercePageUI;
...
public class AbstractPages {
	...
	public void logoutAfterRegister(WebDriver driver,String pageName) {
		waitToElementVisible(driver, AbstractNopCommercePageUI.DYNAMIC_BUTTON_LOG_OUT,pageName);	
		clickToElement(driver, AbstractNopCommercePageUI.DYNAMIC_BUTTON_LOG_OUT,pageName);		
